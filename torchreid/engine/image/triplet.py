...
from torchreid.losses import CrossEntropyLoss, HctLoss
...
class ImageTripletEngine(Engine):
    ...
    def __init__(self, datamanager, model, optimizer, margin=0.3,
                 weight_t=1.0, weight_x=1.0, scheduler=None, use_gpu=True,
                 label_smooth=True):
        super(ImageTripletEngine, self).__init__(datamanager, model, optimizer, scheduler, use_gpu)

        self.weight_t = weight_t
        self.weight_x = weight_x
        self.criterion_t = HctLoss(num_classes=self.datamanager.num_train_pids, feat_dim=2048, margin=margin, use_gpu=self.use_gpu)
